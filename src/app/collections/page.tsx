...
import { COLLECTIONS } from "@/data/site-data";

export default function CollectionsPage() {
  // Filter data based on the 'type' defined in our single source of truth
  const majorSeries = COLLECTIONS.filter((col) => col.type === "series");
  const archiveSeries = COLLECTIONS.filter((col) => col.type === "archive");
